...
public class RestaurantTableDAOTest {
	...
	public void save() {
		...
		if (restaurant == null) {
			...
			// create a new table
			RestaurantTable restaurantTable = new RestaurantTable(restaurant);
			...
			System.out.println(
					"╭────────────────────────────╮\n" + "│ Code: " + restaurantTable.getCode() + "\n" + "│ Number: "
							...
							+ restaurantTable.getRestaurant().getName() + "\n" + "╰────────────────────────────╯");
		}
	}
	...
	public void list() {
		...
		for (RestaurantTable restaurantTable : restaurantTableDAO.list()) {
			System.out.println("├────────────────────────────┤");
			System.out.println("│ Code: " + restaurantTable.getCode() + "\n" + "│ Number: "
					+ restaurantTable.getNumber() + "\n" + "│ Available: " + restaurantTable.getAvailable() + "\n"
					+ "│ Capacity: " + restaurantTable.getCapacity() + "\n" + "│ Restaurant: "
					+ restaurantTable.getRestaurant().getName());
		}
